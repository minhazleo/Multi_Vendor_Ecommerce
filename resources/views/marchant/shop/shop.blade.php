            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <a href="{{route('shop.create')}}" class="btn btn-success mb-2"><i class="mdi mdi-plus-circle me-1"></i> Add Shop</a>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <table class="table table-centered w-100 dt-responsive nowrap" id="products-datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{asset($shop->photo)}}" alt="No Photo" title="contact-img" class="rounded me-3" height="48" />
                                        </td>
                                        <td>
                                            {{$shop->description}}
                                        </td>
                                        ...
                                        <td>
                                            <ul class="list-inline table-action m-0">
                                                <li class="list-inline-item">
                                                    <a href="{{route('shop.edit', $shop->id)}}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                </li>
                                               <li class="list-inline-item">
